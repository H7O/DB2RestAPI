...
namespace DB2RestAPI.Settings
{
    public class DefaultRegex
    {
        ...
        // public static readonly Regex DefaultVariablesCompiledRegex = new Regex(DefaultVariablesPattern, RegexOptions.Compiled);

        public static readonly string DefaultHeadersPattern = @"(?<open_marker>\{header\{)(?<param>.*?)?(?<close_marker>\}\})";
        // public static readonly Regex DefaultHeadersCompiledRegex = new Regex(DefaultHeadersPattern, RegexOptions.Compiled);
        public static readonly string DefaultQueryStringPattern = @"(?<open_marker>\{\{)(?<param>.*?)?(?<close_marker>\}\})";
        // public static readonly Regex DefaultQueryStringCompiledRegex = new Regex(DefaultQueryStringPattern, RegexOptions.Compiled);
        public static readonly string DefaultRouteVariablesPattern = @"(?<open_marker>\{\{)(?<param>.*?)?(?<close_marker>\}\})";
